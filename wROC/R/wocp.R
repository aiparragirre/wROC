...
#' - `ROC01`: \deqn{c_w^{\text{Youden}}=\argmax_c\{(\widehat{Se}_w(c)-1)^2 + (\widehat{Sp}_w(c)-1)^2\},}
#' - `MaxEfficiency`: \deqn{c_w^{\text{Youden}}=\argmax_c\{\hat p_{Y,w}\widehat{Se}_w(c) + (1-\hat p_{Y,w})\widehat{Sp}_w(c)\},}
#'
